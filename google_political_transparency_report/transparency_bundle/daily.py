...
from google_political_transparency_report.common.post_to_slack import post_to_slack
...
if __name__ == "__main__":
    try: 
        ...
        post_to_slack(f"google_political_transparency_report.transparency_bundle.daily error: {e}")
        log.error(e)
        raise e